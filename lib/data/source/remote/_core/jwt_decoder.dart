...
class JwtDecoder {
  ...
  static DateTime getExpirationDate(String token) {
    ...
    final expirationDate = DateTime.fromMillisecondsSinceEpoch(0).add(Duration(seconds: (decodedToken['exp'] as int).toInt()));
  ...
  static Duration getTokenTime(String token) {
    ...
    final issuedAtDate = DateTime.fromMillisecondsSinceEpoch(0).add(Duration(seconds: decodedToken['iat'] as int));
