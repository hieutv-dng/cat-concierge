...
class PetStepPage extends GetView<PetStepController> {
  ...
  Widget _buildBody(BuildContext context) {
    return GetBuilder<PetStepController>(
      init: PetStepController(),
      builder: (controller) {
        return Column(
          ...
          children: [
            GestureDetector(
              onTap: () {
                controller.moveStep(false);
              },
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset(
                  MySvgs.ic_caret_left,
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildProgressStep(context, controller.progressStep.toDouble(), 14),
                    _buildContent(controller.progressStep),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildProgressStep(BuildContext context, double current, double max) {
